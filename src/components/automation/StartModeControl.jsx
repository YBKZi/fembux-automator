...
export default function StartModeControl({ mode, onModeChange, running, onRun, onReset }) {
  return (
    <div className="flex flex-col gap-2.5 rounded-2xl border border-white/10 bg-white/[0.04] p-2.5 backdrop-blur-2xl">
        ...
        {MODES.map((m) => {
          ...
          return (
            <button
              ...
              className={cn(
                "flex flex-1 flex-col items-center justify-center gap-0.5 rounded-lg px-2 py-2 transition-all",
